...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const mailtoLink = `mailto:gokul.jai_e@yahoo.com?subject=Contact from ${formData.name}&body=${formData.message}%0D%0A%0D%0AFrom: ${formData.email}`;
          ...
          <div className="contact-info">
            ...
            <div className="contact-details">
              {contactInfo.map((info, index) => (
                <div key={index} className="contact-item" style={{ animationDelay: `${index * 0.1}s` }}>
            ...
            <div className="social-links">
              <a href="https://github.com" className="social-button" target="_blank" rel="noopener noreferrer">
              ...
              <a href="https://linkedin.com" className="social-button" target="_blank" rel="noopener noreferrer">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
